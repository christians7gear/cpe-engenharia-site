...
export default function HomePage() {
  return (
    <div className="bg-slate-50 min-h-screen">
      {/* 1. HERO SECTION ORIGINAL COM PRÉDIO AZUL */}
      <section className="relative min-h-screen flex items-center justify-center bg-slate-950 text-white overflow-hidden pt-20">
        <div className="absolute inset-0 z-0">
          <Image
            src="https://cdn.abacus.ai/images/3cf78604-3225-4ac4-9f1c-3a27b4958552.png"
            alt="CPE Engenharia Fachada"
            fill
        ...
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div className="space-y-1">
              ...
              <div className="text-xs text-gray-400 font-medium uppercase">Projetos com ART</div>
            </div>
            <div className="space-y-1">
              <div className="text-2xl sm:text-3xl font-black text-red-500">CREA/SP</div>
              <div className="text-xs text-gray-400 font-medium uppercase">Registro Ativo</div>
            </div>
            <div className="space-y-1">
              <div className="text-2xl sm:text-3xl font-black text-red-500">Brasil</div>
              <div className="text-xs text-gray-400 font-medium uppercase">Atendimento a Projetos</div>
            </div>
            <div className="space-y-1">
              <div className="text-2xl sm:text-3xl font-black text-red-500">São Paulo</div>
              <div className="text-xs text-gray-400 font-medium uppercase">Execução de Obras</div>
            </div>
          </div>
        </div>
      </section>
                ...
                <div className="relative w-full h-56 overflow-hidden bg-slate-100">
                  ...
                  <div className="absolute top-3 left-3">
                    <span className="text-[11px] font-bold text-white bg-slate-900/85 backdrop-blur-sm px-3 py-1 rounded-lg border border-white/10">
                      {service.category === "projetos" ? "Projetos Técnicos" : "Execução de Obras"}
                    </span>
                  </div>
                </div>
      ...
      {/* 4. SOBRE A EMPRESA E RESPONSÁVEL TÉCNICO */}
      <section className="bg-white py-20 border-t border-slate-200">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <span className="text-xs font-bold uppercase tracking-wider text-red-600">Sobre a CPE Engenharia</span>
              <h2 className="text-3xl sm:text-4xl font-black text-gray-900 leading-tight">
                Compromisso com a Segurança e a Qualidade Construtiva
              </h2>
              <p className="text-gray-600 text-sm sm:text-base leading-relaxed">
                Fundada sob a liderança do <strong>Eng. Civil Christian Gomes</strong>, a <strong>CPE Engenharia</strong> atua com excelência no mercado de engenharia civil, elaborando projetos arquitetônicos e complementares, além de executar obras residenciais de alto padrão, galpões e postos de combustíveis.
              </p>
              ...
              <div className="pt-2">
                ...
                >
                  Conheça mais sobre nossa história <ArrowRight className="w-4 h-4" />
                </Link>
              </div>
            </div>

            <div className="relative h-[420px] rounded-2xl overflow-hidden shadow-xl border border-slate-200">
              <Image
                src="https://cdn.abacus.ai/images/7ff63605-22e9-4efa-832a-43af18883e18.png"
                alt="Projetos CPE Engenharia"
                fill
      ...
      <section className="bg-slate-950 text-white py-16">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 text-center space-y-6">
          <h2 className="text-2xl sm:text-4xl font-black">
            Pronto para iniciar seu projeto com a <span className="text-red-600">CPE Engenharia</span>?
          </h2>
          <p className="text-gray-400 text-sm sm:text-base max-w-xl mx-auto">
            Entre em contato hoje mesmo para receber um orçamento detalhado e atendimento técnico especializado.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
            <Link
              href="/orcamento"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-red-600 hover:bg-red-700 text-white font-bold py-3.5 px-8 rounded-xl text-sm transition-all shadow-lg"
            >
              Solicitar Orçamento
              <ArrowRight className="w-4 h-4" />
            </Link>
            <a
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700 text-white font-bold py-3.5 px-8 rounded-xl text-sm transition-all shadow-lg"
            >
